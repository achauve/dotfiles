...
if &t_Co > 255
    ...
    hi ClassName            ctermfg=81
    hi DefinedName          ctermfg=81
    hi Enumerator            ctermfg=81
    hi Function           ctermfg=81
    hi EnumerationName    ctermfg=81
    hi Member             ctermfg=81
    hi Structure           ctermfg=81
    hi Type                ctermfg=81
    hi Union               ctermfg=81
    hi GlobalConstant      ctermfg=81
    hi GlobalVariable      ctermfg=81
    hi LocalVariable       ctermfg=81
